...
func generateTopologyConfigForEth(ctx context.Context, c *Credentials, p *ProviderParams, cis []topology.ComputeInstances) (*topology.Vertex, error) {
	contentType := "Content-Type: application/json"
	accept := "accept: application/json"

	creds := fmt.Sprintf("{\"username\":\"%s\" , \"password\":\"%s\"}", c.user, c.passwd)
