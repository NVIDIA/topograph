...
- Compute-instance discovery and provider fan-out now use deterministic region, instance-ID, and node-name ordering, including AWS API requests and InfiniBand probes.
